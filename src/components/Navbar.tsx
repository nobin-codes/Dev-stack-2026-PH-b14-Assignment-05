  ...
  return (
    <header className="sticky top-0 z-50 border-b border-gray-100 bg-white/95 backdrop-blur">
      <nav className="relative mx-auto flex h-16 max-w-[1080px] items-center px-3 sm:px-5 lg:px-0">
        ...
        <a
          href="#home"
          className="absolute left-1/2 top-1/2 z-10 flex -translate-x-1/2 -translate-y-1/2 cursor-pointer"
        >
          <img
            src={logoText}
            alt="Dev Stack Logo"
        ...
        <div className="ml-auto flex shrink-0 items-center gap-1.5 min-[375px]:gap-2 sm:gap-3">
          <button
            type="button"
            className="
              cursor-pointer
