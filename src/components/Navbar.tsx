    ...
    <header className="sticky top-0 z-50 border-b border-gray-100 bg-white/95 backdrop-blur">
      <nav className="relative mx-auto flex h-16 max-w-[1080px] items-center justify-between px-4 sm:px-5 lg:px-0">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <button
            type="button"
            className="text-xs text-gray-700 transition hover:text-pink-500 sm:text-sm"
          >
            Sign In
          </button>
          ...
          <button
            type="button"
            className="gradient-bg rounded-full px-3.5 py-2 text-xs font-medium text-white transition hover:opacity-90 sm:px-5 sm:text-sm"
          >
            Sign Up
          </button>
        </div>
